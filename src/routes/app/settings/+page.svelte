...
<div class="px-4 py-6 space-y-6">
  ...
  <section>
    ...
    <div class="card divide-y divide-surface-200/50 dark:divide-surface-200/20">
      <!-- Theme -->
      <div class="p-4">
        <p class="text-sm font-medium text-surface-700 dark:text-surface-700 mb-3">
          {$_('settings.theme')}
        </p>
      ...
      <label class="flex items-center justify-between cursor-pointer">
        ...
        <div class="relative">
          <input
            ...
            on:change={saveSettings}
          />
          <div class="w-11 h-6 bg-surface-300 dark:bg-surface-300 rounded-full peer peer-checked:bg-accent transition-colors" />
          <div class="absolute left-0.5 top-0.5 w-5 h-5 bg-white rounded-full transition-transform peer-checked:translate-x-5 shadow" />
        </div>
      </label>
    </div>
  </section>
