...
<div class="min-h-screen flex flex-col bg-gradient-to-br from-surface-100 via-surface-50 to-indigo-50 dark:from-surface-950 dark:via-surface-950 dark:to-indigo-950/30">
  <!-- Decorative elements -->
  ...
  <main class="flex-1 flex flex-col items-center justify-center px-6 py-12 relative">
    ...
    {:else}
      ...
      <div class="text-center mb-12 animate-fade-in">
        <div class="w-24 h-24 mx-auto mb-6 bg-gradient-to-br from-accent to-purple-600 rounded-3xl flex items-center justify-center shadow-lg shadow-accent/30 rotate-3 hover:rotate-0 transition-transform duration-300">
      ...
      <div class="w-full max-w-sm space-y-4 animate-slide-up" style="animation-delay: 0.1s;">
        ...
        <div class="relative">
          ...
          <div class="relative flex justify-center text-sm">
            <span class="px-4 bg-gradient-to-br from-surface-100 via-surface-50 to-indigo-50 dark:from-surface-950 dark:via-surface-950 dark:to-indigo-950/30 text-surface-400">
              {$_('auth.orEmail')}
            </span>
          </div>
        </div>
      ...
      <div class="mt-16 grid grid-cols-3 gap-6 text-center animate-slide-up" style="animation-delay: 0.2s;">
        ...
        <div class="space-y-2">
          <div class="w-12 h-12 mx-auto bg-purple-100 dark:bg-purple-900/30 rounded-xl flex items-center justify-center">
