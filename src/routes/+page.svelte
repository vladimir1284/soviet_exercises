  ...
  <main>
    ...
    <section class="py-24 px-6 text-center">
      ...
      >
        ...
        <a href="/signin" class="btn bg-white text-accent hover:bg-surface-50 btn-xl inline-block">
          {$_('landing.heroCta')}
        </a>
      </div>
    </section>
  ...
  <footer class="py-12 px-6 border-t border-surface-200 dark:border-surface-800">
    <div class="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-8">
      ...
      <div class="flex gap-6">
        ...
        >
        <a href="#" class="text-sm text-surface-500 hover:text-accent transition-colors">{$_('landing.footerTerms')}</a>
      </div>
    </div>
  </footer>
</div>
